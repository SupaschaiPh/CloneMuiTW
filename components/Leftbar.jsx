...
const pageIcons = [
  ...
  <SearchRoundedIcon color="secondary" fontSize="large" />,
  <NotificationsRoundedIcon color="secondary" fontSize="large" />,
  <MailRoundedIcon color="secondary" fontSize="large" />,
  <ArticleRoundedIcon color="secondary" fontSize="large" />,
  <BookmarkRoundedIcon color="secondary" fontSize="large" />,
        ...
        return (
          ...
          >
            <div className="hidden max-lg:flex text-black w-full justify-center p-0 lg:p-2">
              <IconButton>{pageIcons[index]}</IconButton>
            </div>
